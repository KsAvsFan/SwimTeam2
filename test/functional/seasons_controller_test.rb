...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { active: @season.active, end_date: @season.end_date, meet_date: @season.meet_date, name: @season.name, start_date: @season.start_date }
    end
  ...
  test "should update season" do
    put :update, id: @season, season: { active: @season.active, end_date: @season.end_date, meet_date: @season.meet_date, name: @season.name, start_date: @season.start_date }
    assert_redirected_to season_path(assigns(:season))
  end
